# odp-diagram-conversion

## Purpose

Converts diagrams drawn with Impress shapes when importing an ODP: plain flowcharts become mermaid diagrams (with callouts on their nodes), other drawings the ordinary conversion would partly lose become SVG images cropped from LibreOffice's export, and without LibreOffice they keep their ordinary conversion and losses. Conversions are reported as info notes rather than losses.
