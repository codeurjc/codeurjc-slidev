...
TBD - defines how the default layout's `content` element is positioned and sized relative to the slide, its ancestors, and the layout editor's overlay, ensuring the visible text area is fully determined by the element's own CSS custom properties.
