...
- `composables/useEditor.ts` — singleton state for element positions, undo, drag/resize, and save (the four fixed elements `red-bar`/`logo`/`title`/`content` + dynamic per-slide keys, e.g. callouts)
